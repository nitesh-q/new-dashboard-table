...
export default function EmployeeAgGrid() {
  ...
  const columnDefs = useMemo(
    () => [
      ...
      { field: "department", filter: true, flex: 1 },
      ...
      },
      {
        ...
        width: 120,
        cellRenderer: (p) => (
          <Badge variant={p.value ? "default" : "secondary"}>
  ...
  return (
    <div className="flex flex-col gap-4 w-full h-full p-2">
      <div className="flex items-center justify-between p-2">
        <h2 className="text-2xl font-bold">Personnel Data</h2>
        <div className="text-sm text-muted-foreground">
          {/* FIX 2: Point to the array length */}
          Showing {employeeData.employees.length} records
        </div>
      </div>
